...
new_job = {
        "title": "Administratorius (-ė) - registratorius (-ė)",
        "company": "UAB Sveikatos centras „Energetikas“",
        "salary": "550-650",
        "location": "Palangoje",
        "address": "Kuršių takas 1, LT-00317 Palanga"
    }
result = firebase.post('/jobs', new_job)
print("===== "+result+" =====")
